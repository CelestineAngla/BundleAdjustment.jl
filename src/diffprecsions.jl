...
# fr_BA = FeasibilityResidual(BA)
# stats1 = Levenberg_Marquardt(fr_BA, :LDL, :Metis, :None, false; x=fr_BA.meta.x0, oatol=1e-2, ortol=1e-2, atol=1e-2, rtol=1e-1, satol=1e-5, srtol=1e-6, restol=1e-5, facto_type=Float16)
# x0_double = convert(Array{Float64,1}, stats1.solution)
# fr_BA = FeasibilityResidual(BA)
# stats2 = Levenberg_Marquardt(fr_BA, :LDL, :AMD, :None, false; x=x0_double)

# BA = BALNLPModel(prob_names[2])
# fr_BA = FeasibilityResidual(BA)
# stats = Levenberg_Marquardt(fr_BA, :LDL, :AMD, :None, false; facto_type=Float32)
...
x0_double = convert(Array{Float64,1}, stats1.solution)
fr_BA = FeasibilityResidual(BA)
stats2 = Levenberg_Marquardt(fr_BA, :LDL, :Metis, :None, false; x=x0_double, Float32)
